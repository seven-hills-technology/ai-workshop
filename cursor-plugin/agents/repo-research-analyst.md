...
1. **Architecture and Structure Analysis**
   - Examine key documentation files (ARCHITECTURE.md, README.md, CONTRIBUTING.md, AGENTS.md, CLAUDE.md)
...
- Respect any AGENTS.md / CLAUDE.md or project-specific instructions found
